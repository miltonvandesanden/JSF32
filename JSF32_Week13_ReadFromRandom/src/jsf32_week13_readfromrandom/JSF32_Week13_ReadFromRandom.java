 ...
 */
package jsf32_week13_readfromrandom;
 ...
 * @author milton
 */
public class JSF32_Week13_ReadFromRandom extends Application
{
    ...
    public void start(Stage primaryStage) {
        ...
        buttonIncreaseLevel.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                {
                    Logger.getLogger(JSF32_Week13_ReadFromRandom.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
        ...
        final JSF32_Week13_ReadFromRandom that = this;
        (new Thread()
        {
            @Override
